...
public class MyQueueTest {
	...
	public void testEnqueue() {
		...
		volQueue.enqueue(new Volunteer("Joe"));	  // Hannah is added as the 3rd person in queue
		assertEquals(volQueue.toArray()[2].toString(), "Hannah");   		
	...
	public void testIsFull() {
		...
		volQueue.enqueue(new Volunteer("Hamza"));
		volQueue.enqueue(new Volunteer("Matt"));
		volQueue.enqueue(new Volunteer("Chin"));
		volQueue.enqueue(new Volunteer("Hannah"));
		volQueue.enqueue(new Volunteer("Sam"));
	...
	public void testDequeue() {
		...
		volQueue.enqueue(new Volunteer("Matt"));
		volQueue.enqueue(new Volunteer("Chin"));		
		volQueue.enqueue(new Volunteer("Mary"));
		volQueue.enqueue(new Volunteer("Shanon")); 
		assertEquals(volQueue.size(),5); 
		
		volQueue.dequeue();     // Will remove Hamza from the queue
		volQueue.dequeue();     // Will remove Matt from the queue
		volQueue.dequeue();     // Will remove Chin from the queue
